"""
Real User-Agent database - 100+ UAs from Windows 10/11 with Chrome/Edge 2024-2025.
Source: whatismybrowser.com/useragents/database
"""

# Chrome on Windows 10/11 - 2024-2025
CHROME_USER_AGENTS = [
    # Chrome 120-131 on Windows 10
    ...
    # Older but still valid Windows versions
...
# All user agents combined - prioritize Chrome (most common)
ALL_USER_AGENTS = (
    CHROME_USER_AGENTS * 3 +  # 3x weight for Chrome
    EDGE_USER_AGENTS * 2 +    # 2x weight for Edge
    OPERA_USER_AGENTS +
    BRAVE_USER_AGENTS
)

# macOS User Agents (for variety)
MACOS_USER_AGENTS = [
